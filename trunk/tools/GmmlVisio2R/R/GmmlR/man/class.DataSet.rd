...
\title{Class "DataSet"}
\description{ This class represents experimental data exported from Gmml-Visio. Every row is a reporter (e.g. microarray probe) and every column is a sample (e.g. a disease stage). } 
