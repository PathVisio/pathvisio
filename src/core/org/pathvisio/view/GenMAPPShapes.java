...
//		ShapeRegistry.registerShape ("ProteinComplex", getPluggableShape (PROTEINB));
	    ShapeRegistry.registerShape ("Cell", getCombinedShape (CELL));
	    ShapeRegistry.registerShape ("Nucleus", getCombinedShape (NUCLEUS));
	    ShapeRegistry.registerShape ("Mitochondria", getCombinedShape (MITOCHONDRIA));
	    ShapeRegistry.registerShape ("Organelle", getCombinedShape (ORGANELLE));
	    ShapeRegistry.registerShape ("Vesicle", getCombinedShape (VESICLE));
...
//	private static final int PROTEINB = 5;
	...
	private static final int NUCLEUS = 2;
	private static final int MITOCHONDRIA = 3;
	private static final int ORGANELLE = 4;
	private static final int VESICLE = 5;
...
//	}
	 ...
	 */
	static private java.awt.Shape getCombinedShape (int st)
	{
		Area area = new Area();
