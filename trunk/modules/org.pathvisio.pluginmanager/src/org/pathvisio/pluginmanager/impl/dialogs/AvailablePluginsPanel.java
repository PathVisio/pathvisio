...
public class AvailablePluginsPanel extends JPanel {
	...
	private JPanel getNorthPanel() {
		FormLayout layout = new FormLayout("5dlu,pref,5dlu,pref,15dlu,pref,5dlu,fill:max(75dlu;pref),fill:pref:grow","5dlu,pref,15dlu,pref,15dlu");
		PanelBuilder builder = new PanelBuilder(layout);
		builder.setBackground(Color.white);
		CellConstraints cc = new CellConstraints();
		builder.addLabel("Status: " + manager.getStatusMessage(), cc.xyw(2, 2, 8));
		
		builder.addLabel("Browse by tag", cc.xy(2, 4));
		...
		builder.add(tagBox, cc.xy(4, 4));
		
		builder.addSeparator("", cc.xyw(2, 5, 8));
