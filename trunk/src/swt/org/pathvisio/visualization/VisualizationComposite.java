...
class VisualizationComposite extends Composite
{
	private VisualizationSettings settingsComp;
	private StackLayout settingsStack;
	private Composite noneSelectedComp;
	private ListViewer visList;
	private Color nonGenericColor;
	private Color genericColor;
	private TableViewer pluginTable;	
	...
	VisualizationComposite (Composite parent, int style)
	{
		super (parent, style);
		createContents();
	}
	...
	void createContents()
	{
		...
		createVisualizationsList(this);
		Composite rightComp = new Composite(this, SWT.NULL);
	...
	private class VisualizationSettings extends Composite {		
		Visualization input;
		Text nameText;
		Label description;
		...
		private class PluginTableModifier implements ICellModifier {
