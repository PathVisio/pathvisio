...
zscore = function(pathway, geneProducts, subset) {
	...
	n = sum(contains(pathway, geneProducts))	## Total number of genes in the pathway
	r = sum(contains(pathway, geneProducts[as.logical(subset)]))## Number of genes that are in the subset and on the pathway
