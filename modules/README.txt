...
org.pathvisio.core 
	reading, writing and drawing pathways
...
org.pathvisio.statistics
	PathVisio plug-in that handles statistical analysis

org.pathvisio.gex
	PathVisio module that handles import of Gene Expression data

org.pathvisio.visualization
	PathVisio module that handles high-throughput data visualization.