...
//			JOptionPane.showMessageDialog(SwingEngine.getCurrent().getFrame(), "Action not implemented");
	...
	private static void createAndShowDlg()
	{
		...
		lstOperators.addMouseListener(new MouseAdapter() 
		{
			public void mouseClicked(MouseEvent me) 
			{
				...
				if (selectedIndex >= 0)
				{
					...
					txtExpr.setText (expr + " " + operators[selectedIndex]);
				}
		...
		frame.add (new JLabel ("Pathway Directory: "), cc.xy (2,8));
		...
		frame.add (btnDir, cc.xy (4,10));
		JButton btnCalc = new JButton ("Calculate");
		frame.add (btnCalc, cc.xyw (2,12,3, "center, top"));
		final JTable tblResult = new JTable ();
		frame.add (new JScrollPane (tblResult), cc.xyw (2,14,3));
		...
		btnCalc.addActionListener(new ActionListener (){
			...
			public void actionPerformed(ActionEvent ae) 
			{
				...
				doCalculate (pwDir, expr, tblResult, frame);
			}
		});
	 ...
	 */
	private static void doCalculate(final File pwDir, String expr, JTable resultTable, JFrame parentFrame)
	{
