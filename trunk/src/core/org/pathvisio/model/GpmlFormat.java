...
public class GpmlFormat 
{
	...
	static Map<String, AttributeInfo> initAttributeInfo()
	{
		...
		result.put("@FontName", new AttributeInfo ("xsd:string", "Arial", "optional"));
		result.put("@FontStyle", new AttributeInfo ("xsd:string", "Normal", "optional"));
		result.put("@FontDecoration", new AttributeInfo ("xsd:string", "Normal", "optional"));
		result.put("@FontStrikethru", new AttributeInfo ("xsd:string", "Normal", "optional"));
		result.put("@FontWeight", new AttributeInfo ("xsd:string", "Normal", "optional"));
		result.put("@FontSize", new AttributeInfo ("xsd:nonNegativeInteger", "12", "optional"));
		result.put("@CenterX", new AttributeInfo ("xsd:float", null, "required"));
		result.put("@CenterY", new AttributeInfo ("xsd:float", null, "required"));
		result.put("@Width", new AttributeInfo ("gpml:Dimension", null, "required"));
		result.put("@Height", new AttributeInfo ("gpml:Dimension", null, "required"));
		...
		result.put("Link@Xref", new AttributeInfo ("xsd:string", null, "optional"));
